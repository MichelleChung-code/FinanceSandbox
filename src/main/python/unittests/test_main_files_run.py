...
class MainFilesRun(unittest.TestCase):
    def test_backtesting(self):
        ...
        from src.main.python.backtesting import backtesting
    ...
    def test_black_scholes_merton(self):
        ...
        from src.main.python.BSM_MonteCarlo import BSM_monte_carlo
    ...
    def test_correlation_matrix(self):
        ...
        from src.main.python.correlation_matrix import plot_corr_mat
    ...
    def test_simple_regression(self):
        ...
        from src.main.python.simple_regression import SimpleRegression
    ...
    def test_simple_stock_data_plot(self):
        ...
        from src.main.python.SimpleStockDataPlot import plot_bar_volume, PlotStockData, extract_data
